...
sap.ui.define(
  ["sap/ui/core/Control", "./3rdparty/Chart", "./library"],
  function (Control, ChartJS, library) {
     ...
     */
    var BaseChartJS = Control.extend(
      "it.designfuture.chartjs.BaseChartJS",
      /** @lends sap.m.BaseChartJS.prototype */ {
        __ctx: undefined,
        __chart: undefined,
        ...
        onAfterRendering: function () {
          ...
          var legendOptions = {
            ...
            onClick: function (event, legendItem) {
              that.fireOnLegendItemClick({
                event: event,
                legendItem: legendItem,
              });
            },
            onHover: function (event, legendItem) {
              that.fireOnLegendItemHover({
                event: event,
                legendItem: legendItem,
              });
            },
          ...
          if (this.getOptions()) {
            Object.assign(globalOptions, this.getOptions());
          }
